...
class StorageService {
     ...
     * @param {string} region
     */
    async uploadFileCustom(localPath, cloudPath, bucket, region) {
        let localFilePath = '';
        ...
        if (fs_1.default.statSync(resolveLocalPath).isDirectory()) {
    ...
    async uploadDirectoryCustom(source, cloudDirectory, bucket, region) {
        // TODO: 支持忽略文件/文件夹
        // 此处不检查路径是否存在
        // 绝对路径 /var/blog/xxxx
