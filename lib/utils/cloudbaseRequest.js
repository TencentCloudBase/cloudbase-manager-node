...
async function cloudBaseRequest(options) {
    ...
    const requestHeaders = Object.assign(Object.assign({}, headers), { 'content-type': 'application/json', 'user-agent': `cloudabse-admin-node/0.1.0`, 'x-tcb-source': 'cloudabse-admin-node, not-scf' });
