...
function isNodeFunction(runtime) {
    var _a;
    // 不严格限制
    return runtime === 'Nodejs10.15' || runtime === 'Nodejs8.9' || ((_a = runtime) === null || _a === void 0 ? void 0 : _a.includes('Nodejs'));
}
// 解析函数配置，换成请求参数
function configToParams(options) {
    ...
    // VPC 网络
    params.VpcConfig = {
        SubnetId: ((_d = (_c = func) === null || _c === void 0 ? void 0 : _c.vpc) === null || _d === void 0 ? void 0 : _d.subnetId) || '',
        VpcId: ((_f = (_e = func) === null || _e === void 0 ? void 0 : _e.vpc) === null || _f === void 0 ? void 0 : _f.vpcId) || ''
    };
    // 运行内存
    ...
    // 函数层
    ((_h = (_g = func) === null || _g === void 0 ? void 0 : _g.layers) === null || _h === void 0 ? void 0 : _h.length) && (params.Layers = func.layers);
    return params;
}
class FunctionService {
    ...
    async updateFunctionConfig(func) {
        ...
        // VPC 网络
        params.VpcConfig = {
            SubnetId: ((_b = (_a = func) === null || _a === void 0 ? void 0 : _a.vpc) === null || _b === void 0 ? void 0 : _b.subnetId) || '',
            VpcId: ((_d = (_c = func) === null || _c === void 0 ? void 0 : _c.vpc) === null || _d === void 0 ? void 0 : _d.vpcId) || ''
        };
        // 内存
        ...
        // 函数层
        ((_f = (_e = func) === null || _e === void 0 ? void 0 : _e.layers) === null || _f === void 0 ? void 0 : _f.length) && (params.Layers = func.layers);
    ...
    async getCodeParams(options, installDependency) {
        ...
        if (((_a = base64Code) === null || _a === void 0 ? void 0 : _a.length) > BIG_LENGTH) {
            throw new error_1.CloudBaseError('base64 不能大于 20 MB');
        }
        if ((_b = base64Code) === null || _b === void 0 ? void 0 : _b.length) {
            return {
                ZipFile: base64Code
            };
        }
        ...
        if (!((_c = base64) === null || _c === void 0 ? void 0 : _c.length)) {
