...
class CommonService {
    constructor(environment, serviceType, serviceVersion) {
        ...
        if (serviceType === 'sts') {
            this.commonService = new utils_1.CloudService(environment.cloudBaseContext, 'sts', serviceVersion || '2018-04-16');
        }
        if (serviceType === 'cam') {
            this.commonService = new utils_1.CloudService(environment.cloudBaseContext, 'cam', serviceVersion || '2018-04-16');
        }
    }
    /**
     * 公共方法调用
